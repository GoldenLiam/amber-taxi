...
const routes = [
  ...
  },
  {
    ...
    key: "stats",
    route: "/stats",
    icon: <i className="bi bi-graph-up" style={{color: "#3a416f", fontSize: "12px"}}></i>,
    component: <></>,
    noCollapse: true,
  },
  {
  ...
  { type: "title", title: "Cuộc gọi", key: "call-pages" },
  {
    type: "collapse",
    name: "Cuộc gọi",
    key: "calling",
    route: "/calling",
    icon: <i className="bi bi-telephone" style={{color: "#3a416f", fontSize: "12px"}}></i>,
    component:
  ...
  },
  {
    ...
    key: "calling-history",
    route: "/calling-history",
    icon: <i className="bi bi-whatsapp" style={{color: "#3a416f", fontSize: "12px"}}></i>,
    component: <></>,
    noCollapse: true,
  },
  ...
  },
  {
    ...
    key: "table-driver-shift",
    route: "/table-driver-shift",
    icon: <i className="bi bi-list-columns-reverse" style={{color: "#3a416f", fontSize: "12px"}}></i>,
    component: <TableDriverShift />,
    noCollapse: true,
  },
  {
    type: "collapse",
